...
Route::middleware(['validaAcesso'])->group(function () {
	...
	Route::group(['prefix' => '/relatorios'], function(){
		...
		Route::get('/relatorioVendasPDV','RelatorioController@relatorioVendasPDV');
	...
	Route::group(['prefix' => 'vendas'],function(){
		...
		Route::get('/relatorioVendas','VendaController@relatorioVendas');
	...
	Route::group(['prefix' => 'frenteCaixa'],function(){
		...
		Route::get('/gerarPdf','FrontBoxController@gerarPdf');
	...
	Route::group(['prefix' => 'produtoEcommerce'], function(){
		...
		Route::get('/alterarControlarEstoque/{id}', 'ProdutoEcommerceController@alterarControlarEstoque');
