...
<head>
	...
	<title>Relatório vendas PDV</title>
</head>
<body>
...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form method="get" action="/relatorio/relatorioVendasPDV">
				<div class="row align-items-center">
					...
					<div class="col-lg-2 col-xl-2 mt-2 mt-lg-0">
						...
						<a href="/frenteCaixa/relatorioVendasPDV" style="margin-top: 15px;" class="btn btn-warning px-6 font-weight-bold">Limpar</a>
					</div>
				</div>
			</form>
			<br>
			<h4>Relatório de Vendas de Frente de Caixa</h4>
													...
													<table class="datatable-table" style="max-width: 100%; overflow: scroll">
														...
														<tbody class="datatable-body">
															...
															<tr class="datatable-row" style="left: 0px; @if($v->estado == 'REJEITADO') background: #ffcdd2; @elseif($v->estado == 'APROVADO') background: #a7ffeb; @endif">
																...
																<td class="datatable-cell"><span class="codigo" style="width: 100px;">{($v->tipo_pagamento)}</spam>
