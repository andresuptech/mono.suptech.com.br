		...
		<div class="col-lg-12">
			...
			<div class="row">
				...
				<div class="col-sm-5 col-lg-5 col-md-12 col-12" id="div-categorias">
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
								<div class="row" style="height: 72px; width: auto">
								<div class="form-group validated col-sm-12 col-lg-12 col-12 col-sm-12" style="margin-top: 10px;">
									...
									<button title="Pagamento Múltiplo" id="click-multi" class="btn btn-info btn-lg">
									...
									@isset($orcamentos)
									<button title="Observação" data-toggle="modal" data-target="#modal-orcamento"  class="btn btn-warning btn-lg">
						...
						<div class="card-body" style="height: 700px; overflow-y: auto; ">
							<div class="row">
								...
								<div class="form-group validated col-sm-12 col-lg-12 col-12 col-sm-12" style="margin-top: 5px;">
									<div class="">
								...
								<div class="form-group validated col-sm-12 col-lg-12 col-12 col-sm-12" style="margin-top: 5px;">
									<div class="">
										<input type="text" placeholder="Valor recebido R$" id="valor_recebido" name="valor_recebido" class="form-control money" value="">
									</div>
								</div>
								<div class="form-group validated col-sm-12 col-lg-12 col-12 col-sm-12">
								...
								<div class="form-group validated col-sm-12 col-lg-12 col-12 col-sm-12">
									<div class="">
										<button id="finalizar-venda" style="width: 100%" class="btn btn-success btn-lg" disabled>
											...
											<span style="font-size: 20px; padding: 25px">Finalizar</span>
											<strong id="total-venda"></strong>
										</button>
									</div>
								</div>
